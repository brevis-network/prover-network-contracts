...
Batch request helpers are also available: `batchGetRequests`, `batchGetBidders`, `batchGetBidHashes`. Proof payloads should be sourced from `ProofSubmitted` events indexed off-chain.
